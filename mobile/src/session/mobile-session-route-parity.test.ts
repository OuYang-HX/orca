...
// [oyhx] refresh: our hardware-keyboard route additions on top of this pin —
// +4 hooks (the intercept toggle, the native-key listener, the tab-switch
// refocus, and its previous-handle ref), +3 effects, +2 `'android'` strings,
// and the blur-refocus callback body. Recorded against our rebased tree.
const HEAD_MAIN_HOOK_SHA256 = 'b9c5ef76bfd1cb92cc18b81376b32cefc0838396ba3ec796cf23c4c95f17d968'
const HEAD_HOOK_BINDING_SHA256 = '5f014a526b3641ea0d646c4712f01f019c4637ed11d519d633e241f8181f4fb4'
...
const HEAD_CALLBACK_BODY_SHA256 = '86f7348d3a48421584297b3efdd2617ae4f71278d6ecb03e6113f0c8bd0fdc71'
...
const HEAD_EFFECT_SHA256 = 'f94fe42c06a541607b5d36f7cec71b884baa744ebc218e45b21a571ec60abbc3'
...
const HEAD_RUNTIME_STRING_SHA256 =
  '67f095168d3080eded5559a20f2d3e76823e2e62cb66c1a8841153e374166af5'
// Moved by both of the dock's fields: their refs, and the live one's submit handler, are the seam's now.
const HEAD_HOST_JSX_SHA256 = '8f6e2df7c09cee2de56d5db0119e7062052d5d0043d7f01888052bb08f319542'
...
describe('mobile session route extraction parity', () => {
  it('preserves hooks, callbacks, effects, and nested action bodies', () => {
    ...
    expect(main.hooks).toHaveLength(285)
